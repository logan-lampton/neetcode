...
class Solution:
    def numberOfLines(self, widths: [int], s: str) -> [int]:
        ...
        for char in s:
            ...
            if 100 - cur_line < char_width:
                num_lines += 1
                cur_line = 0
            cur_line += char_width

        return [num_lines, cur_line]
...
print(solution.numberOfLines([4,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10], s = "bbbcccdddaaa"))