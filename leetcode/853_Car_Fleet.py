...
class Solution:
    def carFleet(self, target: int, position: [int], speed: [int]) -> int:
        ...
        sorted_distance_speed = sorted(distance_speed, reverse=True)
        
        for distance, speed in sorted_distance_speed:
            remaining_dist = target - distance
            turns = remaining_dist / speed
